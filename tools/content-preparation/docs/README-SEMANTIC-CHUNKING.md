...
Semantic chunking is an internal content-preparation capability for grouping
...
The content-preparation project now requires Python `>=3.12,<3.13`.

Semantic chunking dependencies are installed with the main content-preparation
package:
...
part of the existing content-preparation artifact contract.
