...
cli-run-sample:
	tools/gurubodh-cli/.venv/bin/gurubodh prep-subject --project-root tools/gurubodh-cli --subject sub123_spand_rahasya --language hi-IN --environment development --storage-profile local
