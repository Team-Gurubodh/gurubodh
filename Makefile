...
cli-run-sample:
	tools/gurubodh-cli/.venv/bin/gurubodh prep-subject --project-root tools/gurubodh-cli --config jobs/subjects/sub123_spand_rahasya/hi-IN/prep-subject.local.json
