...
- [slice-workflow.md](./slice-workflow.md) - provisional workflow used for the completed #283 profile-contract pilot; repository-wide adoption remains pending under #289 (status checked 2026-09-18).
- `git-github-cli-workflow-tutorial.md` - beginner-oriented command walkthrough for the issue-first workflow using Git and the GitHub CLI.
